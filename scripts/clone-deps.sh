...
echo ""
echo "Next steps:"
echo "1. Build components: cd ../viperblock && make build"
echo "2. Build components: cd ../predastore && make build"
echo "3. Build Hive: make build"
echo "4. Run development setup: ./scripts/dev-setup.sh"
echo ""
echo "📖 For detailed instructions, see:"
echo "   - ./CLAUDE.md (Hive development guide)"
echo "   - ../viperblock/CLAUDE.md (Viperblock guide)"
echo "   - ../predastore/CLAUDE.md (Predastore guide)"