...
func (s *NATSSnapshotService) CreateSnapshot(input *ec2.CreateSnapshotInput, accountID string) (*ec2.Snapshot, error) {
	return utils.NATSRequestWithAccount[ec2.Snapshot](s.natsConn, "ec2.CreateSnapshot", input, 120*time.Second, accountID)
}
...
func (s *NATSSnapshotService) DescribeSnapshots(input *ec2.DescribeSnapshotsInput, accountID string) (*ec2.DescribeSnapshotsOutput, error) {
	return utils.NATSRequestWithAccount[ec2.DescribeSnapshotsOutput](s.natsConn, "ec2.DescribeSnapshots", input, 30*time.Second, accountID)
}

func (s *NATSSnapshotService) DeleteSnapshot(input *ec2.DeleteSnapshotInput, accountID string) (*ec2.DeleteSnapshotOutput, error) {
	return utils.NATSRequestWithAccount[ec2.DeleteSnapshotOutput](s.natsConn, "ec2.DeleteSnapshot", input, 60*time.Second, accountID)
}

func (s *NATSSnapshotService) CopySnapshot(input *ec2.CopySnapshotInput, accountID string) (*ec2.CopySnapshotOutput, error) {
	return utils.NATSRequestWithAccount[ec2.CopySnapshotOutput](s.natsConn, "ec2.CopySnapshot", input, 120*time.Second, accountID)
}
